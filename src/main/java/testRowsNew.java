...
public class testRowsNew {
    ...
    public static void main(String[] args) {
        ...
        List<List<String>> solvedRows = new ArrayList<>(); // Reihe , Belegung in Reihe (List<String>)

        // Liste für verbotene Belegungen in den Zeilen
        List<List<List<String>>> forbiddenRows = new ArrayList<>(); // Reihe, verschiedene verbotene Belegungen für Reihe, verbotene Belegung in Reihe (List<String>)
        for (int i = 0; i < ersterWert; i++) {
            forbiddenRows.add(new ArrayList<>());
        }

        long start = System.nanoTime();

        //solveRow(pieces, fields, ersterWert, 0, solvedRows, forbiddenRows, 1);
    ...
    public static void solveRow(PuzzlePiece[] pieces, PuzzleField[] fields, int ersterWert,  List<List<String>> allFoundFirstRows, int numberOfCalls) {
/*
        // Erstelle Solver
        ...
        try {
            ...
            System.out.println("Suche Lösung für Zeile " + 0);
            ...
            //Iteriere durch alle bereits gefundenen Belegungen der ersten Reihe, verbiete diese um nach neuer Belegung zu suchen
            for ( int i = 0; i < allFoundFirstRows.size(); i++){             //iteriert durch die Anzahl der verbotenen Gesamtbelegungen der gegenwärtigen Reihe
