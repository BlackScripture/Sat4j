...
public class QuadrantSolver {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Gib Wert x für die Dimensionierung der Quadranten ein: ");
        int dritterWert = scanner.nextInt();
    ...
    public static void solveQuadrant(PuzzlePiece[] pieces, PuzzleField[] fields, int ersterWert, int currentQuadrant,  List<List<String>> solvedQuadrants, List<List<List<String>>> forbiddenQuadrants, int numberOfCalls) {
...
/*
        try {
            ...
            System.out.println("Suche Lösung für Zeile " + currentQuadrant);
